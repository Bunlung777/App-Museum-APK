...
<View>
 ...
 <SliderBox
      ...
      <Image
          ...
          />
        <Text style={[styles.text1, styles.textTypo2]}>ค่าเข้าชม : {route.params.Fee}</Text>
      </View>
      ...
      <View style={styles.frameContainer}>
        ...
        <Pressable onPress={() => handleMapPress(route.params.Lat, route.params.Long)}>
        <View style={[styles.parent,{marginTop:10}]}>
